...
<tr><th>Number:</th><td><?php echo form_input('number', quotes_to_entities($row->number), 'size="10"'); ?></td></tr>
...
<tr><th>Color:</th><td><?php echo jscolor_picker('background_color', quotes_to_entities($row->background_color), 'size="12"'); ?></td></tr>
</table>
</div>
