...
<?php endif; ?>
    ...
    <script language="JavaScript" type="text/javascript" src="<?php echo base_url(); ?>js/validate-query.js"></script>
...
<li><a href="<?php echo base_url();?>index.php/admin/attendance/import">Attendance</a></li>
	...
	<li><a href="<?php echo base_url();?>index.php/admin/staff/exportStaffAssignment">Export Staff Schedule</a></li>                
            ...
            <li style="z-index: 95;"><a href="#" style="padding-right: 23px;">Logistics<img src="<?php echo base_url();?>images/admin/ddsmooth_menu/down.gif" class="downarrowclass" style="border:0px;" /></a>
                <ul style="display: none; top: 35px; box-shadow: rgb(170, 170, 170) 5px 5px 5px; -webkit-box-shadow: rgb(170, 170, 170) 5px 5px 5px; visibility: visible;">
               <!-- onclick="alert('Uniform is under developement')"-->
                    <li><a href="<?php echo base_url();?>index.php/admin/uniforms/listings" >View Uniform Stock</a></li>
                    <li><a href="<?php echo base_url();?>index.php/admin/uniforms/history" >Inventory</a></li>
                     <li><a href="<?php echo base_url();?>index.php/admin/uniforms/typeslist" >Uniforms Types List</a></li>
                    <li><a href="<?php echo base_url();?>index.php/admin/uniforms/sizeslist" >Sizes List</a></li>
